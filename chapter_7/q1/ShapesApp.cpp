...
void ShapesApp::BuildRenderItems()
{
    ...
    for(int i = 0; i < 5; ++i)
    {
        ...
        AddRenderItem(RenderLayer::Opaque, worldTransform, mGeometries["shapeGeo"].get(), mGeometries["shapeGeo"]->DrawArgs["geosphere"]);
    ...
    ResourceUploadBatch& uploadBatch)
{
    ...
    // Geosphere
	MeshGenData geosphere = meshGen.CreateGeosphere(0.5f, 3);
	...
	SubmeshGeometry geosphereSubmesh = compositeMesh.AppendSubmesh(geosphere);
