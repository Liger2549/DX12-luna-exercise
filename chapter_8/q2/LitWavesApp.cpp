...
void LitWavesApp::UpdateImgui(const GameTimer& gt)
{
    ...
    ImGui::Checkbox("Flashlight", &mFlashLightOn);
    ImGui::SliderFloat3("Light Strength", &mLightStrength.x, 0.0f, 16.0f);
    ImGui::SliderFloat("Spot Power", &mSpotPower, 1.0f, 64.0f);
...
void LitWavesApp::UpdateMainPassCB(const GameTimer& gt)
{
    ...
    mMainPassCB.gNumSpotLights = 1;

    XMVECTOR eyePos = XMLoadFloat3(&mEyePos);
    XMVECTOR dir = XMVector3Normalize(XMVectorNegate(eyePos));
    XMFLOAT3 viewDir;
    XMStoreFloat3(&viewDir, dir);
    mMainPassCB.gLights[0].Direction = viewDir;
    mMainPassCB.gLights[0].Strength = mFlashLightOn ? mLightStrength : XMFLOAT3(0.0f, 0.0f, 0.0f);
    mMainPassCB.gLights[0].FalloffStart = 5.0f;
    mMainPassCB.gLights[0].FalloffEnd = 256.0f;
    mMainPassCB.gLights[0].Position = mEyePos;
    mMainPassCB.gLights[0].SpotPower = mSpotPower;
