...
void LitWavesApp::UpdateImgui(const GameTimer& gt)
{
    ...
    ImGui::SliderFloat3("Light Strength 0", &mLightStrength0.x, 0.0f, 1.0f);
    ImGui::SliderFloat3("Light Strength 1", &mLightStrength1.x, 0.0f, 1.0f);
    ImGui::SliderFloat3("Light Strength 2", &mLightStrength2.x, 0.0f, 1.0f);

    ImGui::SliderFloat3("Ambient Light", &mgAmbientLight.x, 0.0f, 1.0f);
...
void LitWavesApp::UpdateMainPassCB(const GameTimer& gt)
{
    ...
    mMainPassCB.gAmbientLight = mgAmbientLight;
    ...
    mMainPassCB.gLights[0].Strength = mLightStrength0;
    mMainPassCB.gLights[1].Direction = mRotatedLightDirections[1];
    mMainPassCB.gLights[1].Strength = mLightStrength1;
    mMainPassCB.gLights[2].Direction = mRotatedLightDirections[2];
    mMainPassCB.gLights[2].Strength = mLightStrength2;
