...
private:
    ...
    DirectX::XMFLOAT3 mLightStrength0 = { 0.9f, 0.8f, 0.7f };
    DirectX::XMFLOAT3 mLightStrength1 = { 0.4f, 0.4f, 0.4f };
    DirectX::XMFLOAT3 mLightStrength2 = { 0.2f, 0.2f, 0.2f };
    DirectX::XMFLOAT4 mgAmbientLight = { 0.25f, 0.25f, 0.35f, 1.0f };
