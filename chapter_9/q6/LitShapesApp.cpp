...
void LitShapesApp::LoadTextures()
{
    TextureLib& texLib = TextureLib::GetLib();
...
void LitShapesApp::AddRenderItem(RenderLayer layer, const DirectX::XMFLOAT4X4& world, const DirectX::XMFLOAT4X4& texTransform, Material* mat, MeshGeometry* geo, SubmeshGeometry& drawArgs)
{
...
void LitShapesApp::BuildRenderItems()
{
    ...
    AddRenderItem(RenderLayer::Opaque, worldTransform, texTransform, matLib["tile0"], mGeometries["shapeGeo"].get(), mGeometries["shapeGeo"]->DrawArgs["box"]);
    ...
    for(int i = 0; i < 5; ++i)
    {
        ...
        AddRenderItem(RenderLayer::Opaque, worldTransform, texTransform, matLib["orbBase"], mGeometries["shapeGeo"].get(), mGeometries["shapeGeo"]->DrawArgs["sphere"]);
