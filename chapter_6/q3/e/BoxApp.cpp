...
void BoxApp::Draw(const GameTimer& gt)
{
    ...
    mCommandList->DrawIndexedInstanced(
        mGeo->DrawArgs["triangle"].IndexCount, 
		1,  // instanceCount
        mGeo->DrawArgs["triangle"].StartIndexLocation, 
        mGeo->DrawArgs["triangle"].BaseVertexLocation,
...
void BoxApp::BuildBoxGeometry(ID3D12Device* device, DirectX::ResourceUploadBatch& uploadBatch)
{
	...
	Vertex v2 = { XMFLOAT3(-0.6f,  0.3f, 0.0f), XMFLOAT4(Colors::Red) };
	Vertex v3 = { XMFLOAT3(-0.3f, -0.1f, 0.0f), XMFLOAT4(Colors::Green) };
	Vertex v4 = { XMFLOAT3(-0.1f,  0.5f, 0.0f), XMFLOAT4(Colors::Yellow) };
	Vertex v5 = { XMFLOAT3(0.1f,  0.2f, 0.0f), XMFLOAT4(Colors::Magenta) };
	Vertex v6 = { XMFLOAT3(0.3f,  0.6f, 0.0f), XMFLOAT4(Colors::Blue) };
	Vertex v7 = { XMFLOAT3(0.5f,  0.4f, 0.0f), XMFLOAT4(Colors::Cyan) };
	Vertex v8 = { XMFLOAT3(0.8f,  0.7f, 0.0f), XMFLOAT4(Colors::White) };
	Vertex v9 = { XMFLOAT3(0.9f,  0.1f, 0.0f), XMFLOAT4(Colors::HotPink) };

    std::array<Vertex, 9> vertices =
    {
		v1, v2, v3, v4, v6, v5, v7, v8, v9
    };
