...
void BoxApp::Draw(const GameTimer& gt)
{
    ...
    mCommandList->DrawInstanced(mGeo->DrawArgs["points"].VertexCount, 1, 0, 0);
...
void BoxApp::BuildBoxGeometry(ID3D12Device* device, DirectX::ResourceUploadBatch& uploadBatch)
{
    ...
    {
        Vertex({ XMFLOAT3(-0.9f, -0.2f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3(-0.6f,  0.3f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3(-0.3f, -0.1f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3(-0.1f,  0.5f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3( 0.1f,  0.2f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3( 0.3f,  0.6f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3( 0.5f,  0.4f, 0.0f), XMFLOAT4(Colors::White) }),
        Vertex({ XMFLOAT3( 0.8f,  0.7f, 0.0f), XMFLOAT4(Colors::White) })
    };
