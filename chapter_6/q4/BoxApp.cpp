...
{
	Vertex v1 = { XMFLOAT3(+1.0f, -1.0f, +1.0f), XMFLOAT4(Colors::Green) }; // 0 : Right Bottom Back
	Vertex v2 = { XMFLOAT3(+1.0f, -1.0f, -1.0f), XMFLOAT4(Colors::Green) }; // 1 : Right Bottom Front
	Vertex v3 = { XMFLOAT3(-1.0f, -1.0f, +1.0f), XMFLOAT4(Colors::Green) }; // 2 : Left Bottom Back
	Vertex v4 = { XMFLOAT3(-1.0f, -1.0f, -1.0f), XMFLOAT4(Colors::Green) }; // 3 : Left Bottom Front
	Vertex v5 = { XMFLOAT3( 0.0f,  1.0f, 0.0f), XMFLOAT4(Colors::Red) };   // 4 : tip vertex
